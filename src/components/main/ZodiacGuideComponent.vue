...
const premiumNarratives = {
  uk: {
    ...
    leo: {
      ...
      mantra: 'Я свічу стабільно і веду прикладом, а не тиском.',
    },
    virgo: {
    ...
    capricorn: {
      ...
      deepProfile: 'Козеріг має рідкісну здатність будувати складні цілі в довгу і тримати відповідальність. Його баланс — не плутати жорсткість із силою.',
