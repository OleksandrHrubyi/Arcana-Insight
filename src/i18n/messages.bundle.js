  ...
  en: {
    ...
    tarotOracle: {
      ui: {
        ...
        sheetClose: 'Close',
        rewardBadge: 'Reward',
        dailyUsedBadge: 'Tomorrow',
        clarifyThinking: 'Let me focus this for you…',
        clarifySkip: 'Skip this',
        loadingBase: 'All right. Give me a moment — shaping the interpretation',
        spreadLabels: { 1: '1 card', 3: '3 cards', 5: '5 cards' },
        summaryLine: 'Theme: “{theme}”\n{subtheme}Question: “{question}”\nDepth: {depth}\n{touch}',
        summarySubthemeLine: 'Subtheme: “{subtheme}”\n',
        roleCore: 'Core',
        roles3: ['Root', 'Focus', 'Vector'],
        roles5: ['Base', 'Past', 'Now', 'Shadow', 'Vector'],
        cardN: 'Card',
        reversedSuffix: ' (reversed)',
        reversedTag: ', reversed',
        readingReady: 'The cards are open. Do you want me to move to the interpretation?',
        declinedHint: 'All right. If you want the interpretation, just say so.',
        histTheme: 'Theme',
        histSubtheme: 'Subtheme',
        histQuestion: 'Question',
        histSpread: 'Spread',
        basicTitle: 'Basic interpretation',
        basicOpening: 'The interpretation below is based on card meanings from the library.',
        basicFocus: 'Focus of this spread: {question}',
        premiumKeywords: 'Keywords: {keywords}.',
        premiumActionFocus: 'Action focus: what small step can you take today in the “{role}” area?',
        premiumRecurring: 'Recurring accents: {keywords}.',
        premiumDefaultFocus: 'current focus',
        premiumOpeningUnavailable: 'AI interpretation is temporarily unavailable, so the extended Premium interpretation below is built from spread structure and card meanings.',
        premiumOpeningFocus: 'Extended Premium interpretation for “{focus}”, built from spread structure and each card meaning.',
      ...
      questionTemplates: {
        relationships: {
          ...
          partner: [
            ...
            {
              label: 'Next 30 days',
              text: 'What can I focus on in our relationship over the next 30 days?',
            },
          ],
          ex: [
        ...
        work: {
          ...
          growth: [
            ...
            { label: 'Next 30 days', text: 'What opportunity can I nurture over the next 30 days?' },
          ],
          team: [
        ...
        money: {
          income: [
            ...
            { label: 'Next 30 days', text: 'What can I focus on for my income over the next 30 days?' },
          ],
          expenses: [
            ...
            {
              label: 'Next 30 days',
              text: 'What can strengthen my finances over the next 30 days?',
            },
          ],
          debt: [
          ...
          stability: [
            ...
            { label: 'Next 30 days', text: 'What can support my stability over the next 30 days?' },
          ],
        },
        choice: {
          ab: [
        ...
        self: {
          energy: [
            ...
            {
              label: 'Next 30 days',
              text: 'What can I focus on over the next 30 days if I protect myself?',
            },
          ],
          anxiety: [
    ...
    common: {
      ...
      close: 'Close',
      retry: 'Try again',
      disclaimer: 'For reflection and entertainment — not a prediction of the future.',
    ...
    ritualRewards: {
      ...
      heroTitle: 'All bonuses and pricing',
      heroSubtitle: 'See exact reward prices and how many points you still need.',
      thresholdLabel: 'Progress status',
      thresholdNext: 'Next threshold: {points} pts',
      thresholdAllAffordable: 'All rewards are already affordable.',
      progressLine: 'Collected {collected} of {total} pts',
      unlockedByPoints: 'Unlocked: {unlocked}/{total}',
      claimableNow: 'Claimable now: {count}',
      availableTitle: 'Available now',
      lockedTitle: 'Locked',
      emptyFilter: 'No rewards in this category yet.',
      claimNow: 'Claim',
      claimInProgress: 'Claiming',
      subtitleExtraTarotSpread: 'Extra premium spread',
      subtitleLoveUnlock: 'Love section for 24h',
      subtitleCareerUnlock: 'Career section for 24h',
      subtitleMysticBadge: 'Collectible profile badge',
      subtitleFallback: 'Ritual reward',
      statusReadyToClaim: 'Ready to claim',
      statusActive24h: 'Active 24h',
      statusTokenInInventory: 'Token in inventory',
      statusOwned: 'Owned',
      statusNeedMore: 'Need {points} more pts',
      statusUnavailable: 'Unavailable',
      actionActive: 'Active',
      actionLocked: 'Locked',
      claimErrorInsufficient: 'Not enough points to claim.',
      claimErrorAlreadyOwned: 'This reward is already owned.',
      claimErrorGeneric: 'Failed to claim reward.',
      claimSuccess: 'Reward claimed and added to inventory.',
    },
    ...
    accountPage: {
      ...
      mysticBadgeActive: 'Mystic ritual badge active',
    ...
    compatibilityPage: {
      title: 'Compatibility',
      subtitle: 'A real two-chart reading — Sun, Moon, Venus & Mars for both of you.',
      youLabel: 'You',
      partnerLabel: 'Them',
      dobPlaceholder: 'Add date',
      tapToSet: 'Tap to set birth date',
      sunShort: 'Sun',
      moonShort: 'Moon',
      ...
      revealHint: 'Both birth dates needed · no birth time required',
      scoreLabel: 'Match',
      aspects: {
      ...
      tiers: {
        magnetic: { title: 'Magnetic', headline: 'A powerful, electric pull — this connection runs deep and asks you both to stay awake to it.' },
        harmonious: { title: 'Harmonious', headline: 'Things flow easily here. You meet each other with a natural, unforced understanding.' },
        growing: { title: 'Growing', headline: 'Real potential with room to learn each other — the good parts grow as you do.' },
        complex: { title: 'Complex but worthwhile', headline: 'Different rhythms that can teach you a lot. It rewards patience and honest talk.' },
        challenging: { title: 'Challenging', headline: 'You work in very different ways. With awareness, the friction can become real growth.' },
      },
      dim: {
        attraction: {
          label: 'Attraction',
          high: 'Strong romantic and physical spark — you notice each other and the chemistry stays alive.',
          mid: 'A warm, steady draw. The spark is there and grows with shared experiences.',
          low: 'Attraction here is quieter and slower to build — it leans on closeness over instant chemistry.',
        },
        emotional: {
          label: 'Emotional bond',
          high: 'You read each other’s moods naturally and feel safe being open — a deeply comforting connection.',
          mid: 'You generally understand each other emotionally, with moments that ask for a little extra care.',
          low: 'Your emotional rhythms differ; feeling truly understood takes patience and clear sharing.',
        },
        communication: {
          label: 'Communication',
          high: 'Talking is easy and energising — ideas flow and you rarely run out of things to say.',
          mid: 'You communicate well overall; now and then you’ll need to slow down and clarify.',
          low: 'You think and speak in different styles — good conversations here are built on purpose, not chance.',
        },
        values: {
          label: 'Values & direction',
          high: 'You want similar things from life and move toward them together — a strong shared foundation.',
          mid: 'Your core values mostly align, with a few areas worth talking through openly.',
          low: 'You approach life’s big choices differently — respecting each other’s direction matters most here.',
        },
        energy: {
          label: 'Energy & pace',
          high: 'Your day-to-day rhythms match well — you recharge and take action at a similar tempo.',
          mid: 'Your energy mostly syncs, with occasional differences in pace to balance.',
          low: 'One of you moves faster than the other; finding a shared tempo is the work — and the reward.',
        },
        warmth: {
          label: 'Warmth & care',
          high: 'A genuinely warm, affectionate bond — you look out for each other and it shows.',
          mid: 'A caring connection that deepens over time and through small gestures.',
          low: 'Warmth here is understated; it grows through consistency rather than instant closeness.',
        },
        drive: {
          label: 'Drive & goals',
          high: 'You push each other forward — ambitions align and momentum builds when you team up.',
          mid: 'You get things done together, with occasional differences in tempo to manage.',
          low: 'You chase goals differently; agreeing on pace and priorities is the key to progress.',
        },
        commitment: {
          label: 'Commitment & depth',
          high: 'A real sense of stability and staying power — this bond is built to last and deepen.',
          mid: 'A steady, grounding thread runs through this; commitment grows as trust is earned.',
          low: 'Long-term structure takes conscious effort here — you’ll define the rules of the bond yourselves.',
        },
        growth: {
          label: 'Growth & fun',
          high: 'You expand each other’s world — optimism, generosity and a sense of possibility flow easily.',
          mid: 'There’s room to grow together; shared adventures and plans bring out your best.',
          low: 'You encourage growth in different directions; championing each other’s path matters most.',
        },
      },
      connectionsTitle: 'Key connections',
      connectionsHint: 'Real aspects between your charts · your planet ↔ theirs',
      weatherTitle: 'Your weather this week',
      weatherHint: 'How today’s sky is touching the two of you',
      weatherThemes: {
        affection: 'A window for warmth and closeness',
        passion: 'Desire and intensity run higher',
        focus: 'Attention turns to the two of you',
        talk: 'A good stretch for talking things through',
        ease: 'Things feel lighter and more generous',
        test: 'A more serious, testing note',
      },
      weatherFraming: {
        flowing: '— lean into it.',
        friction: '— move gently here.',
        intense: '— it’s amplified right now.',
      },
      weatherActionLabel: 'This week:',
      weatherActions: {
        affection: 'make a warm gesture and plan something you both enjoy.',
        passion: 'channel the high energy into something active or a shared project.',
        focus: 'give each other real, device-free attention — quality over busyness.',
        talk: 'raise what’s on your mind; it’s a strong stretch for honest talk.',
        ease: 'say yes to a spontaneous plan — things feel generous right now.',
        test: 'be patient and sort one practical thing together; don’t force the rest.',
      },
      planets: {
        sun: 'Sun',
        moon: 'Moon',
      ...
      pairThemes: {
        identity: 'Your core identities',
        heartMind: 'Heart and mind',
        emotionalRhythm: 'Your emotional rhythms',
        expression: 'How you express yourselves',
        affectionId: 'Warmth and personality',
        spark: 'Energy and spark',
        feelingsWords: 'Putting feelings into words',
        tenderness: 'Tenderness and affection',
        emotionalHeat: 'Emotional intensity',
        mentalSync: 'The way you think and talk',
        sweetTalk: 'Easy, warm conversation',
        debate: 'Mental sparring',
        sharedTaste: 'Tastes and values',
        chemistry: 'Physical attraction',
        drive: 'Drive and willpower',
        commitmentTheme: 'Commitment and structure',
        security: 'Emotional security',
        lastingLove: 'Lasting affection',
        longTerm: 'Your long-term rhythm',
        driveRestraint: 'Drive and restraint',
        seriousTalk: 'Serious, grounded talk',
        growthLuck: 'Growth and optimism',
        generosity: 'Generosity and fun',
        emotionalGrowth: 'Emotional generosity',
        sharedVision: 'A shared sense of possibility',
        momentum: 'Momentum and ambition',
        bigIdeas: 'Big ideas and plans',
        balance: 'Ambition and patience',
        connection: 'This connection',
      },
      connFraming: {
        flowing: '— an easy, natural flow between you.',
        friction: '— a point of friction worth navigating.',
        intense: '— strongly amplified between you.',
      },
      aiLoading: 'Reading the connection between your charts…',
      dynamicLabel: 'The dynamic',
      adviceLabel: 'How to get the best from it',
      lockTitle: 'See your full reading',
      lockText: 'Unlock this dimension in Premium.',
      lockCta: 'Unlock Premium',
      shareCta: 'Share',
      newPairing: 'New pairing',
      disclaimer: 'A reflective reading from real placements (Sun through Saturn) — for insight and conversation, not prediction. Add birth time & city for rising sign and house depth.',
      ...
      savedTitle: 'Saved connections',
      saveConnection: 'Save connection',
      deleteConnectionTitle: 'Remove this connection?',
      deleteConnectionText: 'This saved person and their birth data will be permanently removed.',
      saved: 'Saved',
      namePlaceholder: 'Name (e.g. Alex)',
      reminderLabel: 'Weekly relationship check-in',
      reminderTitle: 'Relationship weather',
      reminderBody: 'How’s your week with {name}? See this week’s weather.',
      reminderDenied: 'Notifications are off. Enable them for Arcana in iOS Settings to get the weekly reminder.',
      reminderFailed: 'Couldn’t set the reminder. Please try again.',
      addTimePlace: 'Add birth time & city (for rising sign)',
      birthTime: 'Birth time',
      birthCity: 'Birth city',
      timePlaceHint: 'Optional — unlocks rising sign & house overlays.',
      housesTitle: 'House overlays',
      housesHint: 'Which of each other’s life areas your planets light up',
      houseThemes: {
        1: 'Identity & first impressions',
        2: 'Values, security & resources',
        3: 'Everyday talk & ideas',
        4: 'Home & emotional roots',
        5: 'Romance, joy & creativity',
        6: 'Routines & day-to-day care',
        7: 'Partnership & commitment',
        8: 'Intimacy, trust & depth',
        9: 'Adventure, growth & beliefs',
        10: 'Goals, status & the long game',
        11: 'Friendship, hopes & community',
        12: 'The inner world & the unspoken',
      },
    ...
    tarotSpreads: {
      relationships: {
        three: [
          { label: 'You', meaning: 'What you bring to this connection.' },
          { label: 'Them', meaning: 'Where the other person stands.' },
          { label: 'Between you', meaning: 'What lives in the connection itself.' },
        ],
        five: [
          { label: 'You', meaning: 'What you bring to it right now.' },
          { label: 'Them', meaning: 'Where the other person stands.' },
          { label: 'Between you', meaning: 'The bond itself, between you.' },
          { label: 'Beneath', meaning: 'What is unspoken or unseen.' },
          { label: 'Where it heads', meaning: 'The current direction of the connection.' },
        ],
      },
      work: {
        three: [
          { label: 'Standing', meaning: 'Where you stand in this work right now.' },
          { label: 'Challenge', meaning: 'What is testing or challenging you.' },
          { label: 'Direction', meaning: 'Where the work is moving.' },
        ],
        five: [
          { label: 'Foundation', meaning: 'What this work is built on.' },
          { label: 'Past', meaning: 'What brought you here.' },
          { label: 'Now', meaning: 'Where things stand today.' },
          { label: 'Obstacle', meaning: 'What is standing in the way.' },
          { label: 'Direction', meaning: 'Where it is heading.' },
        ],
      },
      money: {
        three: [
          { label: 'Situation', meaning: 'Where your finances stand right now.' },
          { label: 'Influence', meaning: 'What is shaping the situation.' },
          { label: 'Direction', meaning: 'Where it is moving.' },
        ],
        five: [
          { label: 'Foundation', meaning: 'What your finances rest on.' },
          { label: 'Past', meaning: 'What led here.' },
          { label: 'Now', meaning: 'Where things stand today.' },
          { label: 'Tension', meaning: 'What strains the balance.' },
          { label: 'Direction', meaning: 'Where it is moving.' },
        ],
      },
      choice: {
        three: [
          { label: 'Option A', meaning: 'One path before you.' },
          { label: 'Option B', meaning: 'The other path.' },
          { label: 'Unseen', meaning: 'The factor you are not seeing.' },
        ],
        five: [
          { label: 'Option A', meaning: 'One path before you.' },
          { label: 'Option B', meaning: 'The other path.' },
          { label: 'The heart', meaning: 'What truly matters to you here.' },
          { label: 'Unseen', meaning: 'The factor you are not seeing.' },
          { label: 'Leaning', meaning: 'Where you are currently leaning.' },
        ],
      },
      self: {
        three: [
          { label: 'Now', meaning: 'Where you are right now.' },
          { label: 'The block', meaning: 'The inner block that holds you.' },
          { label: 'Growth', meaning: 'Where you are growing.' },
        ],
        five: [
          { label: 'Foundation', meaning: 'What shapes who you are.' },
          { label: 'Past', meaning: 'What formed this.' },
          { label: 'Now', meaning: 'Where you are today.' },
          { label: 'Shadow', meaning: 'What works beneath the surface.' },
          { label: 'Growth', meaning: 'Where you are heading.' },
        ],
      },
    },

    tarotInterpretation: {
      headerKicker: 'TAROT • INTERPRETATION',
      fallbackTitle: 'Interpretation',
      emptyText: 'No active interpretation. Return to the spread.',
      metaThemeLabel: 'Theme',
      metaSubThemeLabel: 'Subtheme',
      metaQuestionLabel: 'Question',
      ...
      positions: {
        ...
        three: [
          'What this grows from — the root beneath the surface.',
          'Where your attention serves you best right now.',
          'The direction this is currently moving.',
        ],
        five: [
          'The foundation everything here rests on.',
          'What led to this moment.',
          'Where things stand today.',
          'What works quietly beneath the surface.',
          'The direction this is currently moving.',
        ],
      },
    },
    ...
    menuPage: {
      ...
      reflect: {
        ...
        titleDone: 'Reflection saved',
        hint: 'A quiet minute with today’s sky.',
        hintDone: 'Nicely done. Come back tomorrow, or add more.',
        cta: 'Open journal',
      },
      dailyLauncher: {
      ...
      personalized: {
        ...
        readings: 'Card of the day',
      },
      personalizedHints: {
        sky: 'The Moon, planets and events for tonight',
        reflection: 'A quiet minute with today’s sky',
        readings: 'Your daily draw and reading',
      },
    },
    ...
    premiumPage: {
      ...
      compareTable: {
        lead: 'The sky tool and the reflection journal are free in full. Premium adds more places, a longer view of your journal, and the satellite pack.',
        summary: 'Premium = every observing place, 30-day insights, extra satellites — and no daily limits.',
        savedPlaces: { feature: 'Observing places', free: '1 saved place', premium: 'Unlimited saved places' },
        journalInsights: { feature: 'Journal insights', free: '7-day summary', premium: '30-day mood mix + streaks' },
        satellites: { feature: 'Satellite passes', free: 'ISS', premium: 'ISS + Tiangong and Hubble' },
        ...
        history: { feature: 'Reading history', free: 'Not saved', premium: 'All readings saved' },
      ...
      accessModel: {
        title: 'Access model',
        free: 'Free: tonight’s sky in full — Moon, planets, events and ISS passes — plus the reflection journal, daily card, energy reading, and one 1-card reading per day.',
        premium:
          'Premium: unlimited saved observing places, 30-day reflection insights, Tiangong and Hubble passes, all daily themes, full reading history, compatibility insights, and unlimited tarot sessions.',
      ...
      feat: {
        ...
        satellites: 'Satellite pack',
        satellitesSub: 'Tiangong & Hubble passes',
    ...
    journalPage: {
      ...
      breathChip: 'Start with 30 seconds of stillness',
      breathIn: 'Breathe in…',
      ...
      patternsTitle: 'Your week',
      patternsEntryForms: { one: 'entry', few: 'entries', many: 'entries', other: 'entries' },
      patternsMood: 'Mood of the week',
      patternsPhase: 'Most entries under',
      insights: {
        title: 'Reflection insights',
        badge: 'Premium',
        entries: 'entries · 30 days',
        streak: 'day streak',
        moodMix: 'Your mood mix',
        mostUnder: 'You reflect most under a',
        lockTitle: 'See your reflection patterns',
        lockHint: 'Premium: 30-day mood mix, streaks and the Moon phases you journal under.',
      },
    ...
    skyPage: {
      ...
      moonTitle: 'Moon tonight',
      illumination: 'Illumination',
      observeTitle: 'Best time to observe',
      observeMoonless: 'Moonless — ideal for faint deep-sky objects',
      observeAfterMoonset: 'Dark sky opens after the Moon sets · {t}',
      observeBeforeMoonrise: 'Dark now, until the Moon rises · {t}',
      observeMoonWashout: 'Bright Moon ({p}%) up all night — best for the Moon & planets',
      observeNoDarkness: 'No true darkness tonight',
      observeNoDarknessSub: 'Bright twilight lingers all night',
      highest: 'Highest',
      setsAt: 'sets',
      risesAt: 'rises',
      tourTitle: 'Tonight’s tour',
      tour: { moon: 'The Moon', iss: 'The ISS' },
      milkyWayVisible: 'Milky Way core: highest {t} · {alt}° up',
      milkyWayLow: 'Milky Way core barely rises (max {alt}°)',
      milkyWayWashed: 'washed by the Moon',
      meteorRate: '~{zhr}/hr at peak',
      meteorMoon: { low: 'dark skies', moderate: 'some moonlight', high: 'bright Moon' },
      issNotifyTitle: 'ISS pass soon',
      issNotifyBody: 'Look up: {from} → {to}, up to {max}° high',
      satMoreTitle: 'More satellites',
      satBadge: 'Premium',
      satLockTitle: 'See more satellite passes',
      satLockHint: 'Premium: naked-eye passes of Tiangong and Hubble for your location.',
      sats: { css: 'Tiangong (CSS)', hst: 'Hubble' },
      today: 'today',
      tomorrow: 'tomorrow',
      inDays: 'in {n} days',
    ...
    skyHome: {
      ...
      moonSets: 'Sets',
      illuminated: 'illuminated',
      visibleTitle: 'Visible this evening',
      visibleEmpty: 'No planets above the horizon early tonight',
      sunTitle: 'Sun',
      sunrise: 'Sunrise',
      sunset: 'Sunset',
      darkFrom: 'Dark sky from {t}',
      upcomingTitle: 'Upcoming',
      calendarTitle: 'Moon phases this month',
      extrasTitle: 'More',
      extrasReflection: "Today's reflection",
      extrasCard: 'Card of the day',
      extrasHoroscope: 'Your horoscope',
      locationDetect: 'Use my location',
      locationTitle: 'Location',
      savePlace: 'Save this place',
      savedPlacesHint: 'Star a place to save it. Premium saves unlimited places for quick switching.',
      myLocation: 'My location',
      timeZoneNote: 'Times are shown for {city} ({z}), not your device clock.',
      credit: 'Milky Way: ESO/S. Brunier · CC BY 4.0',
      darkShort: 'Dark sky',
      visibleShort: 'Visible',
      openSky: "Tonight's sky",
      moonTitle: 'Moon',
      distance: 'Distance',
      apparentSize: 'Apparent size',
      libration: 'Libration',
      nextPhasesTitle: 'Next phases',
      dawn: 'Dawn',
      goldenHour: 'Golden hour',
      dayLength: 'Day length',
      perigeeShort: 'Perigee',
      apogeeShort: 'Apogee',
      hourAbbr: 'h',
      minAbbr: 'min',
      kmAbbr: 'km',
      belowHorizon: 'Below horizon',
      notifyAria: 'Remind me',
      notifyBody: 'Look up — a sky event is coming.',
      condClear: 'Clear tonight',
      condPartly: 'Partly cloudy',
      condCloudy: 'Cloudy tonight',
      cloudLabel: 'cloud',
      weatherCredit: 'Weather: Open-Meteo',
      conditionsTitle: 'Cloud cover tonight',
      bestWindow: 'Clearest around {t}',
      issTitle: 'ISS passes',
      issEmpty: 'No visible passes in the next few days',
      issMax: 'max',
      today: 'today',
      tomorrow: 'tomorrow',
      inDays: 'in {n} days',
      ...
      events: {
        ...
        fullMoon: 'Full Moon',
        lastQuarter: 'Last Quarter',
        perigee: 'Moon at perigee',
        apogee: 'Moon at apogee',
        lunarEclipse: 'Lunar eclipse',
        solarEclipse: 'Solar eclipse',
        marchEquinox: 'Spring equinox',
        juneSolstice: 'Summer solstice',
        septemberEquinox: 'Autumn equinox',
        decemberSolstice: 'Winter solstice',
        quadrantids: 'Quadrantids meteors',
        lyrids: 'Lyrids meteors',
        etaAquariids: 'Eta Aquariids meteors',
        perseids: 'Perseids meteors',
        orionids: 'Orionids meteors',
        leonids: 'Leonids meteors',
        geminids: 'Geminids meteors',
      },
      cities: {
        kyiv: 'Kyiv',
        warsaw: 'Warsaw',
    ...
    faqPage: {
      ...
      creditMoon: 'Moon photograph: NASA / LRO (public domain)',
    ...
    onboardingPage: {
      ...
      subtitle: 'The real night sky, and a quiet minute a day',
      nextTitle: 'Next',
      nextText: 'Open Home and see tonight’s sky.',
      sectionInterests: 'What brings you here?',
      sectionInterestsHint: 'Pick what you like — you can change it later',
      sectionHint: 'Tip',
      hintText: 'Pick any that fit. You can update this later.',
      selectedLabel: 'Selected',
      selectionHint: 'Optional — it just tailors your start.',
      selectionHintEmpty: 'Pick what fits for a start tailored to you.',
      selectionHintActive: 'Saved to your profile.',
      actionHint: 'Continue to Home',
      skip: 'Skip',
      continue: 'Continue',
      interests: {
        sky: 'The night sky',
  ...
  uk: {
    ...
    tarotOracle: {
      ui: {
        ...
        sheetClose: 'Закрити',
        rewardBadge: 'Бонус',
        dailyUsedBadge: 'Завтра',
        clarifyThinking: 'Дай зосереджу це для тебе…',
        clarifySkip: 'Пропустити',
        loadingBase: 'Добре. Дай мені мить — формую тлумачення',
        spreadLabels: { 1: '1 карта', 3: '3 карти', 5: '5 карт' },
        summaryLine: 'Тема: «{theme}»\n{subtheme}Питання: «{question}»\nГлибина: {depth}\n{touch}',
        summarySubthemeLine: 'Підтема: «{subtheme}»\n',
        roleCore: 'Суть',
        roles3: ['Корінь', 'Фокус', 'Вектор'],
        roles5: ['Основа', 'Минуле', 'Тепер', 'Тінь', 'Вектор'],
        cardN: 'Карта',
        reversedSuffix: ' (перевернута)',
        reversedTag: ', перевернута',
        readingReady: 'Карти відкриті. Бажаєш, щоб я перейшла до тлумачення?',
        declinedHint: 'Добре. Якщо захочеш тлумачення — просто скажи.',
        histTheme: 'Тема',
        histSubtheme: 'Підтема',
        histQuestion: 'Питання',
        histSpread: 'Розклад',
        basicTitle: 'Базове тлумачення',
        basicOpening: 'Тлумачення нижче побудоване на значеннях карт із бібліотеки.',
        basicFocus: 'Фокус цього розкладу: {question}',
        premiumKeywords: 'Ключі: {keywords}.',
        premiumActionFocus: 'Фокус дії: який маленький крок у темі «{role}» ти зробиш сьогодні?',
        premiumRecurring: 'Повторювані акценти: {keywords}.',
        premiumDefaultFocus: 'поточний фокус',
        premiumOpeningUnavailable: 'AI-інтерпретація тимчасово недоступна, тому нижче сформовано розширене Premium-тлумачення на основі структури розкладу та значень карт.',
        premiumOpeningFocus: 'Розширене Premium-тлумачення для фокусу «{focus}». Воно зібране зі структури розкладу та змісту кожної карти.',
      ...
      questionTemplates: {
        relationships: {
          ...
          partner: [
            ...
            { label: '30 днів', text: 'На чому зосередитись у стосунках протягом наступних 30 днів?' },
          ],
          ex: [
        ...
        work: {
          ...
          growth: [
            ...
            { label: '30 днів', text: 'Який шанс я можу розвивати протягом наступних 30 днів?' },
          ],
          team: [
        ...
        money: {
          income: [
            ...
            { label: '30 днів', text: 'На чому зосередитись для доходу протягом наступних 30 днів?' },
          ],
          expenses: [
            ...
            { label: '30 днів', text: 'Що може зміцнити мої фінанси протягом наступних 30 днів?' },
          ],
          debt: [
          ...
          stability: [
            ...
            { label: '30 днів', text: 'Що може підтримати мою стабільність протягом наступних 30 днів?' },
          ],
        },
        choice: {
          ab: [
        ...
        self: {
          energy: [
            ...
            { label: '30 днів', text: 'На чому зосередитись протягом наступних 30 днів, якщо берегти себе?' },
          ],
          anxiety: [
    ...
    settingsPage: {
      ...
      personalization: {
        interestsHint: 'Онови фокус, який використовується для персональних ярликів на головній.',
    ...
    common: {
      ...
      close: 'Закрити',
      retry: 'Спробувати ще',
      disclaimer: 'Для роздумів і розваги — не передбачення майбутнього.',
    ...
    ritualRewards: {
      ...
      heroTitle: 'Усі бонуси та ціни',
      heroSubtitle: 'Тут видно, скільки коштує кожна нагорода та скільки ще потрібно балів.',
      thresholdLabel: 'Статус прогресу',
      thresholdNext: 'Наступний поріг: {points} балів',
      thresholdAllAffordable: 'Усі нагороди вже доступні за балансом.',
      progressLine: 'Зібрано {collected} з {total} балів',
      unlockedByPoints: 'Відкрито: {unlocked}/{total}',
      claimableNow: 'До отримання зараз: {count}',
      availableTitle: 'Доступно зараз',
      lockedTitle: 'Заблоковано',
      emptyFilter: 'У цій категорії поки немає бонусів.',
      claimNow: 'Забрати',
      claimInProgress: 'Обробка',
      subtitleExtraTarotSpread: 'Додатковий преміум розклад',
      subtitleLoveUnlock: 'Секція Love на 24 год',
      subtitleCareerUnlock: 'Секція Career на 24 год',
      subtitleMysticBadge: 'Колекційний бейдж профілю',
      subtitleFallback: 'Нагорода ритуалу',
      statusReadyToClaim: 'Готово до отримання',
      statusActive24h: 'Активно 24г',
      statusTokenInInventory: 'Токен в інвентарі',
      statusOwned: 'Вже отримано',
      statusNeedMore: 'Потрібно ще {points} балів',
      statusUnavailable: 'Недоступно',
      actionActive: 'Активно',
      actionLocked: 'Недоступно',
      claimErrorInsufficient: 'Недостатньо балів, щоб забрати.',
      claimErrorAlreadyOwned: 'Цю нагороду вже отримано.',
      claimErrorGeneric: 'Не вдалося забрати нагороду.',
      claimSuccess: 'Нагороду успішно додано в інвентар.',
    },
    ...
    landing: {
      ...
      sheet: {
        ...
        summaries: {
          ...
          streak:
            'Ця картка не астрологічна: вона показує, як ти реально взаємодієш із застосунком сьогодні.',
    ...
    accountPage: {
      ...
      mysticBadgeActive: 'Містичний ритуал активний',
    ...
    compatibilityPage: {
      title: 'Сумісність',
      subtitle: 'Справжнє читання двох карт — Сонце, Місяць, Венера й Марс обох.',
      youLabel: 'Ти',
      partnerLabel: 'Інший',
      dobPlaceholder: 'Додати дату',
      tapToSet: 'Торкнись, щоб задати дату народження',
      sunShort: 'Сонце',
      moonShort: 'Місяць',
      relTypeLabel: 'Тип стосунків',
      relTypes: {
        romantic: 'Романтика',
        friend: 'Друзі',
        family: 'Сім’я',
      ...
      reveal: 'Показати сумісність',
      revealHint: 'Потрібні обидві дати народження · час не потрібен',
      scoreLabel: 'Збіг',
      aspects: {
        conjunction: 'Зʼєднання',
        sextile: 'Секстиль',
        square: 'Квадрат',
        trine: 'Тригон',
        opposition: 'Опозиція',
        semisextile: 'Напівсекстиль',
        quincunx: 'Квінконс',
        unknown: '',
      },
      tiers: {
        magnetic: { title: 'Магнетична', headline: 'Потужний, наелектризований потяг — цей зв’язок глибокий і просить вас обох лишатися уважними.' },
        harmonious: { title: 'Гармонійна', headline: 'Тут усе тече легко. Ви зустрічаєте одне одного з природним, невимушеним розумінням.' },
        growing: { title: 'Та, що зростає', headline: 'Реальний потенціал із простором пізнавати одне одного — гарне міцнішає разом із вами.' },
        complex: { title: 'Складна, але цінна', headline: 'Різні ритми, що можуть багато навчити. Винагороджує терпіння й чесну розмову.' },
        challenging: { title: 'Виклична', headline: 'Ви дієте дуже по-різному. З усвідомленістю тертя може стати справжнім ростом.' },
      },
      dim: {
        attraction: {
          label: 'Притягання',
          high: 'Сильна романтична й фізична іскра — ви помічаєте одне одного, і хімія лишається живою.',
          mid: 'Тепле, стійке тяжіння. Іскра є й міцнішає зі спільним досвідом.',
          low: 'Притягання тут тихіше й повільніше — воно спирається на близькість, а не на миттєву хімію.',
        },
        emotional: {
          label: 'Емоційний зв’язок',
          high: 'Ви природно зчитуєте настрої одне одного й почуваєтесь безпечно бути відкритими — глибоко затишний зв’язок.',
          mid: 'Загалом ви розумієте одне одного емоційно, з моментами, що просять трохи більше турботи.',
          low: 'Ваші емоційні ритми різні; відчути справжнє розуміння — це терпіння й чесний обмін.',
        },
        communication: {
          label: 'Комунікація',
          high: 'Говорити легко й наснажливо — ідеї течуть, і вам рідко бракує тем.',
          mid: 'Загалом ви добре спілкуєтесь; час від часу варто сповільнитись і прояснити.',
          low: 'Ви думаєте й говорите в різних стилях — добрі розмови тут будуються свідомо, а не випадково.',
        },
        values: {
          label: 'Цінності й напрям',
          high: 'Ви хочете схожого від життя й рухаєтесь до цього разом — міцний спільний фундамент.',
          mid: 'Ваші головні цінності здебільшого збігаються, з кількома темами для відкритої розмови.',
          low: 'Ви по-різному підходите до великих рішень — тут найважливіше поважати напрям одне одного.',
        },
        energy: {
          label: 'Енергія й темп',
          high: 'Ваші щоденні ритми добре збігаються — ви відновлюєтесь і дієте в схожому темпі.',
          mid: 'Ваша енергія здебільшого синхронна, з періодичною різницею темпу, яку варто балансувати.',
          low: 'Хтось рухається швидше за іншого; знайти спільний темп — це робота і водночас винагорода.',
        },
        warmth: {
          label: 'Тепло й турбота',
          high: 'Справді теплий, ніжний звʼязок — ви дбаєте одне про одного, і це помітно.',
          mid: 'Турботливий звʼязок, що глибшає з часом і дрібними жестами.',
          low: 'Тепло тут стримане; воно росте радше через сталість, ніж миттєву близькість.',
        },
        drive: {
          label: 'Драйв і цілі',
          high: 'Ви підштовхуєте одне одного вперед — амбіції збігаються, і разом набираєте темп.',
          mid: 'Разом можете багато досягати, з періодичною різницею темпу.',
          low: 'Ви йдете до цілей по-різному; узгодити темп і пріоритети — ключ до руху.',
        },
        commitment: {
          label: 'Відданість і глибина',
          high: 'Справжнє відчуття стабільності й тривкості — цей звʼязок створений тривати й глибшати.',
          mid: 'Тут проходить стійка, заземлювальна нитка; відданість міцнішає в міру довіри.',
          low: 'Довготривала структура тут потребує свідомих зусиль — правила звʼязку ви визначите самі.',
        },
        growth: {
          label: 'Ріст і легкість',
          high: 'Ви розширюєте світ одне одного — оптимізм, щедрість і відчуття можливостей течуть легко.',
          mid: 'Є простір рости разом; спільні пригоди й плани розкривають вас найкраще.',
          low: 'Ви заохочуєте ріст у різні боки; найважливіше — підтримувати шлях одне одного.',
        },
      },
      connectionsTitle: 'Ключові звʼязки',
      connectionsHint: 'Справжні аспекти між вашими картами · твоя планета ↔ її',
      weatherTitle: 'Ваша погода цього тижня',
      weatherHint: 'Як сьогоднішнє небо торкається вас двох',
      weatherThemes: {
        affection: 'Вікно для тепла й близькості',
        passion: 'Бажання й інтенсивність зростають',
        focus: 'Увага звертається до вас двох',
        talk: 'Гарний час проговорити важливе',
        ease: 'Усе відчувається легше й щедріше',
        test: 'Серйозніша, перевірча нота',
      },
      weatherFraming: {
        flowing: '— скористайтеся цим.',
        friction: '— тут рухайтесь мʼякше.',
        intense: '— зараз це підсилено.',
      },
      weatherActionLabel: 'Цього тижня:',
      weatherActions: {
        affection: 'зробіть теплий жест і сплануйте щось приємне для обох.',
        passion: 'спрямуйте високу енергію в активність або спільний проєкт.',
        focus: 'подаруйте одне одному увагу без гаджетів — якість, а не метушня.',
        talk: 'підніміть те, що на душі; зараз гарний час для чесної розмови.',
        ease: 'скажіть «так» спонтанному плану — зараз усе відчувається щедріше.',
        test: 'будьте терплячі й розберіть разом одну практичну річ; решту не форсуйте.',
      },
      planets: {
        sun: 'Сонце',
        moon: 'Місяць',
      ...
      pairThemes: {
        identity: 'Ваші особистості',
        heartMind: 'Серце і розум',
        emotionalRhythm: 'Ваші емоційні ритми',
        expression: 'Як ви виражаєте себе',
        affectionId: 'Тепло й вдача',
        spark: 'Енергія та іскра',
        feelingsWords: 'Слова для почуттів',
        tenderness: 'Ніжність і прихильність',
        emotionalHeat: 'Емоційна інтенсивність',
        mentalSync: 'Як ви думаєте й говорите',
        sweetTalk: 'Легке, тепле спілкування',
        debate: 'Інтелектуальні суперечки',
        sharedTaste: 'Смаки й цінності',
        chemistry: 'Фізичне притягання',
        drive: 'Воля й напористість',
        commitmentTheme: 'Відданість і структура',
        security: 'Емоційна безпека',
        lastingLove: 'Тривала прихильність',
        longTerm: 'Ваш довготривалий ритм',
        driveRestraint: 'Порив і стриманість',
        seriousTalk: 'Серйозна, заземлена розмова',
        growthLuck: 'Ріст і оптимізм',
        generosity: 'Щедрість і легкість',
        emotionalGrowth: 'Емоційна щедрість',
        sharedVision: 'Спільне відчуття можливостей',
        momentum: 'Імпульс і амбіції',
        bigIdeas: 'Великі ідеї та плани',
        balance: 'Амбіції і терпіння',
        connection: 'Цей звʼязок',
      },
      connFraming: {
        flowing: '— природний, легкий потік між вами.',
        friction: '— точка тертя, варта уваги.',
        intense: '— сильно підсилено між вами.',
      },
      aiLoading: 'Читаю зв’язок між вашими картами…',
      dynamicLabel: 'Динаміка',
      adviceLabel: 'Як отримати найкраще',
      lockTitle: 'Побач повне читання',
      lockText: 'Відкрий цей вимір у Premium.',
      lockCta: 'Відкрити Premium',
      shareCta: 'Поділитися',
      newPairing: 'Нова пара',
      disclaimer: 'Рефлексивне читання з реальних положень (Сонце — Сатурн) — для інсайту й розмови, не для пророцтва. Додай час і місто народження для висхідного знаку та домів.',
      ...
      savedTitle: 'Збережені звʼязки',
      saveConnection: 'Зберегти звʼязок',
      deleteConnectionTitle: 'Видалити цей звʼязок?',
      deleteConnectionText: 'Цю збережену людину та її дані народження буде видалено назавжди.',
      saved: 'Збережено',
      namePlaceholder: 'Імʼя (напр. Олена)',
      reminderLabel: 'Щотижневе нагадування про стосунки',
      reminderTitle: 'Погода стосунків',
      reminderBody: 'Як твій тиждень з {name}? Подивись погоду цього тижня.',
      reminderDenied: 'Сповіщення вимкнені. Увімкни їх для Arcana в Налаштуваннях iOS, щоб отримувати щотижневе нагадування.',
      reminderFailed: 'Не вдалося налаштувати нагадування. Спробуй ще раз.',
      addTimePlace: 'Додати час і місто (для висхідного)',
      birthTime: 'Час народження',
      birthCity: 'Місто народження',
      timePlaceHint: 'Опційно — відкриває висхідний знак і доми.',
      housesTitle: 'Накладання домів',
      housesHint: 'У які сфери життя одне одного потрапляють ваші планети',
      houseThemes: {
        1: 'Особистість і перше враження',
        2: 'Цінності, безпека й ресурси',
        3: 'Щоденні розмови та ідеї',
        4: 'Дім та емоційне коріння',
        5: 'Романтика, радість і творчість',
        6: 'Рутина й щоденна турбота',
        7: 'Партнерство та відданість',
        8: 'Близькість, довіра й глибина',
        9: 'Пригоди, ріст і переконання',
        10: 'Цілі, статус і довга гра',
        11: 'Дружба, мрії та спільнота',
        12: 'Внутрішній світ і несказане',
      },
      previewEyebrow: 'Огляд за сонячними знаками',
      emptyTitle: 'Обери два знаки',
      emptyText:
        'Вибери обидва знаки, щоб побачити обґрунтований огляд: що тут іде легше, де частіше з’являється напруга і що допомагає цій парі працювати краще.',
      ...
      scope: {
        ...
        text: 'Це широкий огляд за сонячними знаками. Він використовує лише стихію і модальність, тому має бути підказкою для роздумів, а не фінальним вердиктом.',
      },
      overview: {
        easy: {
          title: 'Легкий потік',
      ...
      details: {
        ...
        modelTitle: 'Ця сторінка дає огляд за сонячними знаками, а не персональну синастрію.',
        modelText:
    ...
    premiumAccess: {
      ...
      horoscope: {
        love: {
          ...
          text: 'У безкоштовній версії доступна щоденна тема енергії. Premium додає щоденний погляд на кохання і глибший контекст стосунків.',
        },
        career: {
          title: 'Тема карʼєри доступна в Premium',
          text: 'У безкоштовній версії доступна щоденна тема енергії. Premium додає щоденний карʼєрний фокус і практичні наступні кроки.',
        },
      },
      compatibility: {
      ...
      spreads: {
        notify:
          'У безкоштовній версії доступний розклад на 1 карту. Premium відкриває розклади на 3 і 5 карт із глибшою інтерпретацією.',
      },
      tarot: {
        dailyLimit:
        ...
        aha: {
          ...
          lead: 'Ти вже отримав базовий безкоштовний інсайт. Premium додає глибину, більше контексту і чіткі наступні кроки.',
          previewLabel: 'PREMIUM PREVIEW',
          previewFallback:
    ...
    tarotSpreads: {
      relationships: {
        three: [
          { label: 'Ти', meaning: 'Що ти приносиш у цей зв\'язок.' },
          { label: 'Вони', meaning: 'Де стоїть інша людина.' },
          { label: 'Між вами', meaning: 'Що живе в самому зв\'язку.' },
        ],
        five: [
          { label: 'Ти', meaning: 'Що ти приносиш зараз.' },
          { label: 'Вони', meaning: 'Де стоїть інша людина.' },
          { label: 'Між вами', meaning: 'Сам зв\'язок, між вами.' },
          { label: 'Під поверхнею', meaning: 'Що невисловлене чи непомітне.' },
          { label: 'Куди йде', meaning: 'Куди рухається цей зв\'язок.' },
        ],
      },
      work: {
        three: [
          { label: 'Позиція', meaning: 'Де ти стоїш у цій роботі зараз.' },
          { label: 'Виклик', meaning: 'Що тебе випробовує.' },
          { label: 'Напрям', meaning: 'Куди рухається робота.' },
        ],
        five: [
          { label: 'Основа', meaning: 'На чому ця робота тримається.' },
          { label: 'Минуле', meaning: 'Що привело тебе сюди.' },
          { label: 'Тепер', meaning: 'Де все стоїть сьогодні.' },
          { label: 'Перешкода', meaning: 'Що стоїть на шляху.' },
          { label: 'Напрям', meaning: 'Куди це прямує.' },
        ],
      },
      money: {
        three: [
          { label: 'Ситуація', meaning: 'Де зараз стоять твої фінанси.' },
          { label: 'Вплив', meaning: 'Що формує ситуацію.' },
          { label: 'Напрям', meaning: 'Куди це рухається.' },
        ],
        five: [
          { label: 'Основа', meaning: 'На чому тримаються твої фінанси.' },
          { label: 'Минуле', meaning: 'Що привело сюди.' },
          { label: 'Тепер', meaning: 'Де все стоїть сьогодні.' },
          { label: 'Напруга', meaning: 'Що порушує рівновагу.' },
          { label: 'Напрям', meaning: 'Куди це рухається.' },
        ],
      },
      choice: {
        three: [
          { label: 'Варіант А', meaning: 'Один шлях перед тобою.' },
          { label: 'Варіант Б', meaning: 'Інший шлях.' },
          { label: 'Невидиме', meaning: 'Чинник, якого ти не бачиш.' },
        ],
        five: [
          { label: 'Варіант А', meaning: 'Один шлях перед тобою.' },
          { label: 'Варіант Б', meaning: 'Інший шлях.' },
          { label: 'Серцевина', meaning: 'Що для тебе справді важливо.' },
          { label: 'Невидиме', meaning: 'Чинник, якого ти не бачиш.' },
          { label: 'Нахил', meaning: 'Куди ти зараз схиляєшся.' },
        ],
      },
      self: {
        three: [
          { label: 'Тепер', meaning: 'Де ти зараз.' },
          { label: 'Блок', meaning: 'Внутрішній блок, що тримає тебе.' },
          { label: 'Зростання', meaning: 'Де ти зростаєш.' },
        ],
        five: [
          { label: 'Основа', meaning: 'Що формує те, ким ти є.' },
          { label: 'Минуле', meaning: 'Що це сформувало.' },
          { label: 'Тепер', meaning: 'Де ти сьогодні.' },
          { label: 'Тінь', meaning: 'Що працює під поверхнею.' },
          { label: 'Зростання', meaning: 'Куди ти прямуєш.' },
        ],
      },
    },

    tarotInterpretation: {
      headerKicker: 'ТАРО • ТЛУМАЧЕННЯ',
      fallbackTitle: 'Тлумачення',
      emptyText: 'Немає активного тлумачення. Повернись до розкладу.',
      metaThemeLabel: 'Тема',
      metaSubThemeLabel: 'Підтема',
      metaQuestionLabel: 'Питання',
      endSessionLabel: 'Завершити сеанс',
      newSessionLabel: 'Новий сеанс',
      overviewLabel: 'Суть розкладу',
      cardsLabel: 'Карти',
      adviceLabel: 'Підсумок',
      premiumBadge: 'PREMIUM',
      cardFallback: 'Карта',
      saved: 'Збережено',
      freeGift: {
      ...
      positions: {
        ...
        three: [
          'З чого це зростає — корінь під поверхнею.',
          'Де твоя увага зараз найкорисніша.',
          'Куди це зараз рухається.',
        ],
        five: [
          'Основа, на якій усе тут тримається.',
          'Що привело до цього моменту.',
          'Де все стоїть сьогодні.',
          'Що тихо працює під поверхнею.',
          'Куди це зараз рухається.',
        ],
      },
    },
    ...
    menuPage: {
      ...
      reflect: {
        eyebrow: 'Сьогодні',
        title: 'Рефлексія дня',
        titleDone: 'Рефлексію збережено',
        hint: 'Тиха хвилина з небом сьогодні.',
        hintDone: 'Чудово. Повертайся завтра або додай ще.',
        cta: 'Відкрити щоденник',
      },
      dailyLauncher: {
        eyebrow: 'Ритуал дня',
      ...
      personalized: {
        sky: 'Небо сьогодні',
        reflection: 'Рефлексія дня',
        readings: 'Карта дня',
      },
      personalizedHints: {
        sky: 'Місяць, планети й події на сьогодні',
        reflection: 'Тиха хвилина з небом сьогодні',
        readings: 'Твоя карта дня і тлумачення',
      },
    },
    ...
    premiumPage: {
      ...
      compareTable: {
        lead: 'Небо і щоденник рефлексії безкоштовні повністю. Premium додає більше місць, довший погляд на щоденник і пакет супутників.',
        summary: 'Premium = усі місця спостереження, інсайти за 30 днів, більше супутників — і без денних лімітів.',
        savedPlaces: { feature: 'Місця спостереження', free: '1 збережене', premium: 'Без ліміту' },
        journalInsights: { feature: 'Інсайти щоденника', free: 'Зведення за 7 днів', premium: 'Мікс настроїв за 30 днів + серії' },
        satellites: { feature: 'Прольоти супутників', free: 'МКС', premium: 'МКС + Тяньгун і Габбл' },
        ...
        history: { feature: 'Історія читань', free: 'Не зберігаються', premium: 'Усі читання збережені' },
      ...
      accessModel: {
        ...
        free: 'Free: небо сьогодні повністю — Місяць, планети, події і прольоти МКС — плюс щоденник рефлексії, карта дня, читання енергії та один розклад на 1 карту щодня.',
        premium:
          'Premium: необмежені збережені місця спостереження, інсайти рефлексії за 30 днів, прольоти Тяньгун і Габбла, усі щоденні теми, повна історія читань, інсайти сумісності та необмежені сесії таро.',
      ...
      premiumDetails: {
        ...
        fullInterpretation: {
          ...
          text: 'Отримуєш структурований AI-вивід: патерн, фокус, практика і питання для щоденника.',
        },
        structuredInterpretation: {
        ...
        compatibility: {
          ...
          text: 'Бачиш розширений аналіз пари з розбивкою балів за сферами: емоції, комунікація, стабільність.',
        },
        history: {
      ...
      feat: {
        ...
        satellites: 'Пакет супутників',
        satellitesSub: 'Прольоти Тяньгун і Габбла',
      ...
      demo: {
        ...
        practiceHints: {
          one: 'Роби 10-хвилинний вечірній самоаналіз, щоб закривати «відкриті петлі».',
    ...
    zodiacGuidePage: {
      ...
      introText:
        'Відкрий свій знак і читай як коротку самоперевірку: базова енергія, сильні сторони та де тримати баланс.',
      mySign: {
        title: 'Твій знак',
    ...
    journalPage: {
      ...
      breathChip: 'Почни з 30 секунд тиші',
      breathIn: 'Вдих…',
      breathOut: 'Видих…',
      dayWord: 'День',
      ...
      patternsTitle: 'Твій тиждень',
      patternsEntryForms: { one: 'запис', few: 'записи', many: 'записів', other: 'записів' },
      patternsMood: 'Настрій тижня',
      patternsPhase: 'Найбільше записів у фазу',
      insights: {
        title: 'Інсайти рефлексії',
        badge: 'Premium',
        entries: 'записів · 30 днів',
        streak: 'днів поспіль',
        moodMix: 'Твій мікс настроїв',
        mostUnder: 'Найчастіше рефлексуєш у фазу',
        lockTitle: 'Побач свої патерни рефлексії',
        lockHint: 'Premium: мікс настроїв за 30 днів, серії та фази Місяця, під якими ти пишеш.',
      },
    ...
    skyPage: {
      ...
      moonTitle: 'Місяць сьогодні',
      illumination: 'Освітленість',
      observeTitle: 'Коли спостерігати',
      observeMoonless: 'Без Місяця — ідеально для тьмяних об’єктів далекого космосу',
      observeAfterMoonset: 'Темне небо після заходу Місяця · {t}',
      observeBeforeMoonrise: 'Темно зараз, доки не зійде Місяць · {t}',
      observeMoonWashout: 'Яскравий Місяць ({p}%) усю ніч — найкраще для Місяця й планет',
      observeNoDarkness: 'Сьогодні немає справжньої темряви',
      observeNoDarknessSub: 'Яскраві сутінки тривають усю ніч',
      highest: 'Найвище',
      setsAt: 'заходить',
      risesAt: 'сходить',
      tourTitle: 'Тур неба сьогодні',
      tour: { moon: 'Місяць', iss: 'МКС' },
      milkyWayVisible: 'Ядро Чумацького Шляху: найвище {t} · {alt}°',
      milkyWayLow: 'Ядро Чумацького Шляху ледь сходить (макс {alt}°)',
      milkyWayWashed: 'засвічене Місяцем',
      meteorRate: '~{zhr}/год у піку',
      meteorMoon: { low: 'темне небо', moderate: 'трохи Місяця', high: 'яскравий Місяць' },
      issNotifyTitle: 'Скоро проліт МКС',
      issNotifyBody: 'Дивись угору: {from} → {to}, до {max}° над горизонтом',
      satMoreTitle: 'Більше супутників',
      satBadge: 'Premium',
      satLockTitle: 'Дивись більше прольотів супутників',
      satLockHint: 'Premium: видимі неозброєним оком прольоти Тяньгун і Габбла для твоєї локації.',
      sats: { css: 'Тяньгун (CSS)', hst: 'Габбл' },
      today: 'сьогодні',
      tomorrow: 'завтра',
      inDays: 'через {n} дн.',
    ...
    skyHome: {
      ...
      moonSets: 'Захід',
      illuminated: 'освітлений',
      visibleTitle: 'Видно цього вечора',
      visibleEmpty: 'Рано ввечері планет над горизонтом немає',
      sunTitle: 'Сонце',
      sunrise: 'Схід',
      sunset: 'Захід',
      darkFrom: 'Темне небо з {t}',
      upcomingTitle: 'Найближче',
      calendarTitle: 'Фази Місяця цього місяця',
      extrasTitle: 'Ще',
      extrasReflection: 'Рефлексія дня',
      extrasCard: 'Карта дня',
      extrasHoroscope: 'Твій гороскоп',
      locationDetect: 'Моє місцезнаходження',
      locationTitle: 'Локація',
      savePlace: 'Зберегти це місце',
      savedPlacesHint: 'Познач місце зіркою, щоб зберегти. Premium зберігає безліч місць для швидкого перемикання.',
      myLocation: 'Моє місцезнаходження',
      timeZoneNote: 'Час показано для міста {city} ({z}), а не за годинником пристрою.',
      credit: 'Чумацький Шлях: ESO/S. Brunier · CC BY 4.0',
      darkShort: 'Темне небо',
      visibleShort: 'Видно',
      openSky: 'Небо сьогодні',
      moonTitle: 'Місяць',
      distance: 'Відстань',
      apparentSize: 'Видимий розмір',
      libration: 'Лібрація',
      nextPhasesTitle: 'Наступні фази',
      dawn: 'Світанок',
      goldenHour: 'Золота година',
      dayLength: 'Тривалість дня',
      perigeeShort: 'Перигей',
      apogeeShort: 'Апогей',
      hourAbbr: 'год',
      minAbbr: 'хв',
      kmAbbr: 'км',
      ...
      notifyAria: 'Нагадати',
      notifyBody: 'Підніми погляд — наближається подія неба.',
      condClear: 'Ясно вночі',
      condPartly: 'Часткова хмарність',
      condCloudy: 'Хмарно вночі',
      cloudLabel: 'хмарність',
      weatherCredit: 'Погода: Open-Meteo',
      conditionsTitle: 'Хмарність вночі',
      bestWindow: 'Найясніше близько {t}',
      issTitle: 'Прольоти МКС',
      issEmpty: 'Найближчими днями видимих прольотів немає',
      issMax: 'макс',
      today: 'сьогодні',
      tomorrow: 'завтра',
      inDays: 'через {n} дн.',
      retrograde: 'ретроградний',
      compass: { n: 'Пн', ne: 'ПнСх', e: 'Сх', se: 'ПдСх', s: 'Пд', sw: 'ПдЗх', w: 'Зх', nw: 'ПнЗх' },
      events: {
        newMoon: 'Молодик',
        firstQuarter: 'Перша чверть',
        fullMoon: 'Повня',
        lastQuarter: 'Остання чверть',
        perigee: 'Місяць у перигеї',
        apogee: 'Місяць в апогеї',
        lunarEclipse: 'Місячне затемнення',
        solarEclipse: 'Сонячне затемнення',
        marchEquinox: 'Весняне рівнодення',
        juneSolstice: 'Літнє сонцестояння',
        septemberEquinox: 'Осіннє рівнодення',
        decemberSolstice: 'Зимове сонцестояння',
        quadrantids: 'Метеори Квадрантиди',
        lyrids: 'Метеори Ліриди',
        etaAquariids: 'Метеори Ета-Аквариди',
        perseids: 'Метеори Персеїди',
        orionids: 'Метеори Оріоніди',
        leonids: 'Метеори Леоніди',
        geminids: 'Метеори Геменіди',
      },
      cities: {
        kyiv: 'Київ',
        warsaw: 'Варшава',
    ...
    faqPage: {
      ...
      sectionCredits: 'Джерела',
      creditMoon: 'Фото Місяця: NASA / LRO (суспільне надбання)',
    ...
    onboardingPage: {
      title: 'Вітаємо в Arcana',
      subtitle: 'Справжнє нічне небо і тиха хвилина на день',
      nextTitle: 'Далі',
      nextText: 'Відкрий головну і подивись небо сьогодні.',
      sectionInterests: 'Що тебе привело?',
      sectionInterestsHint: 'Обери, що подобається — можна змінити пізніше',
      sectionHint: 'Порада',
      hintText: 'Обери, що пасує. Змінити можна пізніше.',
      selectedLabel: 'Обрано',
      selectionHint: 'Необовʼязково — просто підлаштує твій старт.',
      selectionHintEmpty: 'Обери, що пасує, для персонального старту.',
      selectionHintActive: 'Збережено.',
      actionHint: 'Продовжити на головну',
      skip: 'Пропустити',
      continue: 'Далі',
      interests: {
        sky: 'Нічне небо',
        reflection: 'Щоденна рефлексія',
        readings: 'Читання',
      },
    },
    personalHoroscope: {
