export const messages = {
  en: {
    ...
    personalHoroscope: {
      ...
      errorNoBirthDate: 'Add your birth date in account settings to unlock this.',
      noBirthDateBtn: 'Go to settings',
      moonLabel: 'Moon in',
  ...
  uk: {
    ...
    personalHoroscope: {
      ...
      errorNoBirthDate: 'Додай дату народження в налаштуваннях акаунту.',
      noBirthDateBtn: 'До налаштувань',
      moonLabel: 'Місяць у',
