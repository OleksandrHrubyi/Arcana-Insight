    ...
    compatibilityPage: {
      ...
      dim: {
        ...
        emotional: {
          ...
          low: 'Ваші емоційні ритми різні; відчути справжнє розуміння — це терпіння й чесне ділення.',
        },
        communication: {
          label: 'Комунікація',
      ...
      saved: 'Збережено',
      namePlaceholder: 'Імʼя (напр. Alex)',
