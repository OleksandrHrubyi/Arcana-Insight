export const messages = {
  en: {
    ...
    compatibilityPage: {
      ...
      disclaimer: 'A reflective sign-level reading (Sun, Moon, Venus, Mars) — for insight and conversation, not prediction. Add birth time later for rising-sign depth.',
  ...
  uk: {
    ...
    compatibilityPage: {
      ...
      disclaimer: 'Рефлексивне читання на рівні знаків (Сонце, Місяць, Венера, Марс) — для інсайту й розмови, не для пророцтва. Додай час народження пізніше для глибини висхідного знаку.',
