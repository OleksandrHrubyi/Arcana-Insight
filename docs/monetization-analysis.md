...
1. **Let users taste AI once — the biggest lever.** Give every new user ONE free AI tarot interpretation (or a sample personal horoscope) — e.g., the first-ever reading is the deep AI version, then it reverts to basic + the paywall. People convert when they've *felt* the premium quality, not when they're told about it. High impact, low risk.
