...
| Tarot | `/tarot` | `components/TarotOraclePage.vue` (3185) | none:1 console:10 | 🟡 | Largest file. Verify free-session gating clarity; trim debug logs. |
| Tarot Interpretation | `/tarot-interpretation` | `pages/TarotInterpretationPage.vue` (719) | console:5 | 🟡 | Result readability + premium upsell honesty. |
