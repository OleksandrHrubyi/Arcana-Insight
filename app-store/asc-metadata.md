...
> appear in the Name, Subtitle, Promotional Text, or the description's first paragraph —
> they live in keywords and the feature list only. Same app record + bundle ID; only the
> storefront name changes.
...
**App Name** (≤30) — 24
```
Zorya: Daily Sky Journal
```
> uk localization: `Зоря — щоденник неба`
...
```
Zorya is a daily reflection journal guided by the real sky. One quiet minute a day: check in with your mood, see what today's sky actually looks like — the Moon's sign and phase, the day's ruling planet, the day number — and answer one grounded question written for this exact day.
...
Zorya speaks in themes, patterns, and questions — never guarantees or predictions about the future. It is a tool for self-reflection and entertainment.
...
Start with one honest minute today. Zorya — named for the Slavic goddess of the morning star — helps you slow down, reflect, and notice what matters.

— Subscription —
Zorya Premium is an auto-renewable subscription.
...
```
Welcome to Zorya — a daily reflection ritual guided by the real sky.
...
Thank you for trying Zorya. We'd love your feedback.
```
...
```
Zorya (previously submitted as "Arcana: Tarot & Horoscope", rejected under 4.3(b))
has been repositioned per your guidance: it is now a daily reflection journal
guided by real astronomy. The first-run flow, home screen primary action, name,
and screenshots all lead with the reflection ritual (mood check-in + real sky
data + one reflective question/day, computed on-device with astronomy-engine).
...
```
Зоря — щоденник рефлексії, який веде справжнє небо. Одна тиха хвилина на день: відзнач настрій, подивись, яким є небо саме сьогодні — знак і фаза Місяця, планета дня, число дня — і дай відповідь на одне приземлене питання, написане для цього дня.
...
Зоря говорить темами, патернами й питаннями — без гарантій чи передбачень майбутнього. Це інструмент для самоаналізу та розваги.
...
Почни з однієї чесної хвилини сьогодні. Зоря — на честь слов'янської богині ранкової зорі — допомагає сповільнитися, поміркувати й помітити головне.

— Підписка —
Zorya Premium — це автоматично поновлювана підписка.
...
```
Вітаємо в Зорі — щоденний ритуал рефлексії, який веде справжнє небо.
...
Дякуємо, що пробуєш Зорю. Будемо раді твоєму відгуку.
```
