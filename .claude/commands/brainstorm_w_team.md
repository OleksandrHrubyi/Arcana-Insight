...
2. Explore the codebase to understand existing patterns, architecture, and relevant files — use Glob, Grep, and Read directly (no subagents)
3. Identify what you DO understand and what you DON'T from the prompt alone
4. Formulate your first round of questions
...
19. Save the complete implementation plan to `PLAN_OUTPUT_DIRECTORY/<descriptive-name>.md`
